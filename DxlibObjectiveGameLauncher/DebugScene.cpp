	...
	textSample1(PosVec(750, 700), PosVec(), "mplus1", "文字列", Color255(135, 200, 56), TextAlign::CENTER, true)
{
	...
	debugButton.SetInnerColor(Color255(255, 255, 255), Color255(230, 230, 230, 150), Color255(150, 150, 150, 100), Color255(200, 200, 200));
	debugButton.SetOutlineColor(Color255(132, 220, 75), Color255(100, 190, 75, 150), Color255(86, 170, 50), Color255(110, 200, 75), 5);
	debugButton.SetInnerAnimation(.2f);
	debugButton.SetOuterAnimation(.2f);
	
	debugButton2.SetInnerColor(Color255(255, 200, 255, 128), Color255(235, 180, 235, 255), Color255(170, 115, 170, 100), Color255(200, 145, 200));
