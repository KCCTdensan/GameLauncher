	...
	textSample1(PosVec(750, 700), PosVec(), "mplus1", "文字列", Color255(135, 200, 56), TextAlign::CENTER, true)
{
	...
	debugButton.SetInnerColor(Color255(255, 255, 255), Color255(230, 230, 230), Color255(150, 150, 150, 200), Color255(200, 200, 200));
	debugButton.SetOutlineColor(
		Color255(132, 220, 75, 0),
		Color255(100, 190, 75, 255),
		Color255(86, 170, 50),
		Color255(110, 200, 75), 5);
	debugButton.SetInnerAnimation(.1f);
	debugButton.SetOuterAnimation(.1f);
