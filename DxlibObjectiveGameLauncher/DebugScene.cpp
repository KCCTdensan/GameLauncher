	...
	textSample1(PosVec(750, 700), PosVec(), "mplus1", "文字列", Color255(135, 200, 56), TextAlign::CENTER, true)
{
	...
	debugButton.SetOutlineColor(Color255(132, 220, 75), Color255(100, 190, 75), Color255(86, 170, 50), Color255(110, 200, 75), 5);
	debugButton.SetInnerAnimation(.2f);
	debugButton.SetOuterAnimation(.5f);
	
	debugButton2.SetInnerColor(Color255(255, 200, 255), Color255(235, 180, 235), Color255(170, 115, 170), Color255(200, 145, 200));
	debugButton2.SetInnerAnimation(.2f);
