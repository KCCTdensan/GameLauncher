...
//#endif
	...
	//SceneManager::ChangeScene("Music Player", new PlayerScene(SceneManager::GetSharingScenes())); // 最初に表示するページ
	SceneManager::ChangeScene("Work Register", new WorkRegisterScene(SceneManager::GetSharingScenes())); // 最初に表示するページ
